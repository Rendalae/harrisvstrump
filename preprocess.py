...
def create_word_sequence(df, punct_opt = True, word_seq = False): #applies the preprocessing, if punct_opt = True keeps '!?'

    def preprocessing(sentence, punct_opt = punct_opt):
